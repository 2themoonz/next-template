...
export const Container = styled.div`
  ${tw`py-2.5 border-b border cursor-pointer select-none fixed top-0 bg-white w-full z-50`}
...
export const NavLink = styled(Link)`
  ${tw`font-sans text-xs font-semibold text-gray-800`}
`;

export const NavTitle = styled.h1`
  ${tw`text-xl font-normal text-black`}
`;
